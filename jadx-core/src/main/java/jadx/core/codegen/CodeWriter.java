...
public class CodeWriter {
    ...
    private static final String[] INDENT_CACHE = { "", INDENT_STR, INDENT_STR + INDENT_STR, INDENT_STR + INDENT_STR + INDENT_STR, INDENT_STR + INDENT_STR + INDENT_STR + INDENT_STR, INDENT_STR + INDENT_STR + INDENT_STR + INDENT_STR + INDENT_STR };
