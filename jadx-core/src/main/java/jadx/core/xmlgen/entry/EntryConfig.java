    ...
    private String getLocaleString() {
        ...
        if (localeVariant == null && localeScript == null && (region[0] != '\00' || language[0] != '\00') && region.length != 3) {
            ...
            if (language[0] == '\00' && region[0] == '\00') {
                // early return, no language or region
                return sb.toString();
            }
            sb.append("-b+");
            if (language[0] != '\00') {
