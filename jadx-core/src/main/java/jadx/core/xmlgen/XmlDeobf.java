...
public class XmlDeobf {
    ...
    @Nullable
    public static String deobfClassName(@Nullable RootNode rootNode, @Nullable String potencialClassName, @Nullable String packageName) {
    ...
    @Nullable
    private static String getNewClassName(@Nullable RootNode rootNode, @Nullable String old) {
