...
public class ResProtoParser implements IResParser {
    ...
    private String parse(Configuration c) {
        ...
        // unknown field
        c.getProduct();
        return new EntryConfig(mcc, mnc, language, new char[] { '\00' }, orientation, touchscreen, density, keyboard, navigation, inputFlags, screenWidth, screenHeight, sdkVersion, screenLayout, uiMode, smallestScreenWidthDp, screenWidthDp, screenHeightDp, new char[] { '\00' }, new char[] { '\00' }, screenLayout2, colorMode, false, size).getQualifiers();
    }
