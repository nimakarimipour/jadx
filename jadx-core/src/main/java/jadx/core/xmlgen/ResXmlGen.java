...
public class ResXmlGen {
     ...
     */
    private static final Set<String> SKIP_RES_TYPES = new HashSet<>(Arrays.asList("anim", "animator", "font", // skip id type, it is usually auto generated when used this syntax "@+id/my_id"
    "id", "interpolator", "layout", "menu", "mipmap", "navigation", "raw", "transition", "xml"));
