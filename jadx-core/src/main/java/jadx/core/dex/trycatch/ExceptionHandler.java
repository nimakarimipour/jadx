...
public class ExceptionHandler {
    ...
    public boolean equals(Object o) {
        ...
        return handlerOffset == that.handlerOffset && catchTypes.equals(that.catchTypes) && Objects.equals(tryBlock, that.tryBlock);
    }

    @Override
    public int hashCode() {
        return Objects.hash(catchTypes, handlerOffset);
    }
