...
public class ExceptionHandler {
    ...
    public boolean equals(Object o) {
        ...
        return handleOffset == that.handleOffset && catchTypes.equals(that.catchTypes) && Objects.equals(tryBlock, that.tryBlock);
    }

    @Override
    public int hashCode() {
        return Objects.hash(catchTypes, handleOffset);
    }
