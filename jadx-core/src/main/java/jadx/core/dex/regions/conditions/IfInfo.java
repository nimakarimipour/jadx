...
public final class IfInfo {
    ...
    public IfInfo(IfCondition condition, BlockNode thenBlock, @Nullable BlockNode elseBlock) {
    ...
    public IfInfo(IfInfo info, @Nullable BlockNode thenBlock, @Nullable BlockNode elseBlock) {
        this(info.getCondition(), thenBlock, elseBlock, info.getMergedBlocks(), info.getSkipBlocks(), info.getForceInlineInsns());
    }

    private IfInfo(IfCondition condition, @Nullable BlockNode thenBlock, @Nullable BlockNode elseBlock, Set<BlockNode> mergedBlocks, Set<BlockNode> skipBlocks, List<InsnNode> forceInlineInsns) {
    ...
    public static IfInfo invert(IfInfo info) {
        ...
        IfInfo tmpIf = new IfInfo(invertedCondition, info.getElseBlock(), info.getThenBlock(), info.getMergedBlocks(), info.getSkipBlocks(), info.getForceInlineInsns());
