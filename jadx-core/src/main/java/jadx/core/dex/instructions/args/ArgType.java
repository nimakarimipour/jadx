...
public abstract class ArgType {
    ...
    private static final class GenericType extends ObjectType {
        ...
        @Override
        boolean internalEquals(Object obj) {
            return super.internalEquals(obj) && extendTypes.equals(((GenericType) obj).extendTypes);
        }
    ...
    private static final class WildcardType extends ObjectType {
        ...
        @Override
        boolean internalEquals(Object obj) {
            return super.internalEquals(obj) && bound == ((WildcardType) obj).bound && type.equals(((WildcardType) obj).type);
        }
    ...
    private static class GenericObject extends ObjectType {
        ...
        public GenericObject(String obj, @Nullable List<ArgType> generics) {
            super(obj);
        ...
        @Override
        boolean internalEquals(Object obj) {
            return super.internalEquals(obj) && Objects.equals(generics, ((GenericObject) obj).generics);
        }
    ...
    private static class OuterGenericObject extends ObjectType {
        ...
        @Override
        boolean internalEquals(Object obj) {
            return super.internalEquals(obj) && Objects.equals(outerType, ((OuterGenericObject) obj).outerType) && Objects.equals(innerType, ((OuterGenericObject) obj).innerType);
        }
    ...
    public static ArgType tryToResolveClassAlias(RootNode root, @Nullable ArgType type) {
