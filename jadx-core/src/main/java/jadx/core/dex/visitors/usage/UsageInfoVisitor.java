...
@JadxVisitor(name = "UsageInfoVisitor", desc = "Scan class and methods to collect usage info and class dependencies", runAfter = { // add method override as use
OverrideMethodVisitor.class, // sort by alias name
RenameVisitor.class })
