...
public class IfMakerHelper {
    ...
    @Nullable
    static IfInfo makeIfInfo(@Nullable BlockNode ifBlock) {
    ...
    @Nullable
    private static BlockNode getCrossBlock(@Nullable BlockNode first, @Nullable BlockNode second) {
    ...
    private static boolean isSameBlocks(@Nullable BlockNode first, @Nullable BlockNode second) {
    ...
    @Nullable
    private static IfInfo getNextIfNodeInfo(IfInfo info, @Nullable BlockNode block) {
