...
public class TypeCompare {
    ...
    public TypeCompareEnum compareTypes(ArgType first, ArgType second) {
        ...
        if (firstPrimitive && secondPrimitive) {
            ...
            if (swapEquals(firstPrimitiveType, secondPrimitiveType, PrimitiveType.CHAR, PrimitiveType.BYTE) || swapEquals(firstPrimitiveType, secondPrimitiveType, PrimitiveType.CHAR, PrimitiveType.SHORT)) {
                return CONFLICT;
            }
