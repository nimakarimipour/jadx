...
@JadxVisitor(name = "EnumVisitor", desc = "Restore enum classes", runAfter = { CodeShrinkVisitor.class, ModVisitor.class }, runBefore = { ExtractFieldInit.class })
public class EnumVisitor extends AbstractVisitor {
    ...
    @Nullable()
    private List<EnumField> extractEnumFieldsFromInsn(ClassNode cls, BlockNode staticBlock, InsnNode wrappedInsn, List<InsnNode> toRemove) {
    ...
    @Nullable()
    private List<EnumField> extractEnumFieldsFromFilledArray(ClassNode cls, InsnNode arrFillInsn, BlockNode staticBlock, List<InsnNode> toRemove) {
