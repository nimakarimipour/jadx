...
// ternary operator inlined
// ternary operator inlined
// regions processing finished
CodeShrinkVisitor.class, ModVisitor.class, ReSugarCode.class, IfRegionVisitor.class, CheckRegions.class }, runBefore = { ExtractFieldInit.class })
