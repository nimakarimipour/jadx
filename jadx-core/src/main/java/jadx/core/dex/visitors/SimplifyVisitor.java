...
public class SimplifyVisitor extends AbstractVisitor {
	...
	@NullUnmarked private InsnNode simplifyInsn(MethodNode mth, InsnNode insn, @Nullable InsnNode parentInsn) {
	...
	@NullUnmarked private InsnNode simplifyStringConstructor(MethodNode mth, ConstructorInsn insn) {
	...
	@NullUnmarked private static InsnNode processCast(MethodNode mth, IndexInsnNode castInsn, @Nullable InsnNode parentInsn) {
	 ...
	 */
	@NullUnmarked private static InsnNode convertInvoke(MethodNode mth, InvokeNode insn) {
	...
	@NullUnmarked private static InsnNode convertStringBuilderChain(MethodNode mth, InvokeNode toStrInsn, List<InsnNode> chain) {
		try {
	...
	@NullUnmarked private static InsnArg getArgFromAppend(InsnNode chainInsn) {
	...
	@NullUnmarked private static InsnNode simplifyArith(ArithNode arith) {
	 ...
	 */
	@NullUnmarked private static ArithNode convertFieldArith(MethodNode mth, InsnNode insn) {
		InsnArg arg = insn.getArg(0);
		if (!arg.isInsnWrap()) {
			return null;
		}
