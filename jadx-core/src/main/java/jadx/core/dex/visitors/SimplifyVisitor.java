...
public class SimplifyVisitor extends AbstractVisitor {
	...
	private void simplifyArgs(MethodNode mth, InsnNode insn) {
	 ...
	 @Nullable private static InsnNode processCast(MethodNode mth, IndexInsnNode castInsn, @Nullable InsnNode parentInsn) {
	 ...
	 */
	 @Nullable private static InsnNode convertInvoke(MethodNode mth, InvokeNode insn) {
	...
	private static List<InsnNode> collectUseChain(MethodNode mth, InvokeNode insn, RegisterArg instanceArg) {
	 ...
	 @Nullable private static InsnNode convertStringBuilderChain(MethodNode mth, InvokeNode toStrInsn, List<InsnNode> chain) {
		try {
	...
	private static List<InsnNode> flattenInsnChainUntil(InsnNode insn, InsnType insnType) {
	 ...
	 @Nullable private static InsnArg getArgFromAppend(InsnNode chainInsn) {
	 ...
	 */
	 @Nullable private static ArithNode convertFieldArith(MethodNode mth, InsnNode insn) {
		InsnArg arg = insn.getArg(0);
		if (!arg.isInsnWrap()) {
			return null;
		}
