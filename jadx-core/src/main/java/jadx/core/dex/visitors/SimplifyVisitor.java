...
public class SimplifyVisitor extends AbstractVisitor {
	...
	@Nullable private MethodInfo stringGetBytesMth;
	...
	@Nullable private InsnNode simplifyInsn(MethodNode mth, InsnNode insn, @Nullable InsnNode parentInsn) {
	...
	@NullUnmarked @Nullable private static InsnNode processCast(MethodNode mth, IndexInsnNode castInsn, @Nullable InsnNode parentInsn) {
	...
	@NullUnmarked private static boolean isCastDuplicate(IndexInsnNode castInsn) {
	...
	private static boolean shadowedByOuterCast(RootNode root, @Nullable ArgType castType, @Nullable InsnNode parentInsn) {
	 ...
	 */
	@NullUnmarked private static void simplifyTernary(MethodNode mth, TernaryInsn insn) {
	 ...
	 */
	@NullUnmarked @Nullable private static InsnNode convertInvoke(MethodNode mth, InvokeNode insn) {
	...
	@NullUnmarked private static List<InsnNode> collectUseChain(MethodNode mth, InvokeNode insn, RegisterArg instanceArg) {
	...
	@NullUnmarked @Nullable private static InsnNode convertStringBuilderChain(MethodNode mth, InvokeNode toStrInsn, List<InsnNode> chain) {
		try {
	...
	@NullUnmarked @Nullable private static InsnArg getArgFromAppend(InsnNode chainInsn) {
	...
	@Nullable private static InsnNode simplifyArith(ArithNode arith) {
	 ...
	 */
	@NullUnmarked @Nullable private static ArithNode convertFieldArith(MethodNode mth, InsnNode insn) {
		InsnArg arg = insn.getArg(0);
		if (!arg.isInsnWrap()) {
			return null;
		}
