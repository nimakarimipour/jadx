...
public final class ResourcesLoader {
    ...
    @Nullable
    static ResContainer loadContent(@Nullable JadxDecompiler jadxRef, ResourceFile rf) {
        try {
    ...
    private static ResContainer loadContent(@Nullable JadxDecompiler jadxRef, ResourceFile rf, InputStream inputStream) throws IOException {
        switch(rf.getType()) {
            case MANIFEST:
            case XML:
